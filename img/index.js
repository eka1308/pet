     ...
     <div class="card-top"  >
      ...
      alt="фото кота ${cat.name}"
       ...
       /> </div>
        ...
        <small class="text-muted"><div class="${cat.favorite} like" data-action="love" data-like="favorite"></div></small>
        </div>
...
const generateCatCardinModal = (cat) => {
...
$btnWrapper.addEventListener('click', async (event) => {
  const action = event.target.dataset.action;
...
//   // TODO: как то вывести сразу этого кота (перезапросить всех котов)
// })
